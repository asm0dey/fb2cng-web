...
### Task 1 · `fb2cng-web-k853`: Config — swap forward-auth fields for OIDC/session fields
...
### Task 2 · `fb2cng-web-mmov`: Signed session cookie (stdlib only)
...
### Task 3 · `fb2cng-web-x2qg`: Authenticator core + OIDC verification + group gate
...
### Task 4 · `fb2cng-web-17f6`: HTTP handlers + gating middleware
...
### Task 5 · `fb2cng-web-akte`: Wire the server + main, delete forward-auth
...
### Task 6 · `fb2cng-web-7im2`: Docs — README and compose example
