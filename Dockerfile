...
FROM --platform=$BUILDPLATFORM bellsoft/alpaquita-linux-base:stream-musl@sha256:b2a795bdfbf97bc2bef7bc32f1076440e0c9a4ee46ffc7c7ec3832483a3cd0fc AS fbc
...
FROM --platform=$BUILDPLATFORM bellsoft/alpaquita-linux-go:1.26.7-musl@sha256:f130131d2302b0b08c989ba1e8a43e115a5a98fa6f2339b10676564b0db17e69 AS build
ARG TARGETOS
ARG TARGETARCH
WORKDIR /src
COPY go.mod go.sum ./
...
FROM bellsoft/hardened-base:musl@sha256:1f03f94eb77af9ccadaaaf0c800f969b49cfd2cee7dc6517ed84e4f63d4a960c
